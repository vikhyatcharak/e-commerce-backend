...
export const createPickupLocation = async ({ location_name, address, city, state, pincode, phone, is_default = false }) => {
    ...
    const [result] = await db().query(`
        INSERT INTO pickup_locations (location_name, address, city, state, pincode, phone, is_default) 
        VALUES (?, ?, ?, ?, ?, ?, ?)`,
        [location_name, address, city, state, pincode, phone, is_default]
    )
